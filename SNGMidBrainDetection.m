classdef SNGMidBrainDetection < handle
    ...
    properties
        SpotNGliaObject
        BrainSegmentation %input parameters from SNGInputParameters
    end
    ...
    methods
        function objB = SNGMidBrainDetection(SpotNGliaObject) %constructor
            ...
            objB.BrainSegmentation = SpotNGliaObject.SngInputParameters.BrainSegmentation;
        
            
            SpotNGliaObject.CompleteTemplate.EdgeTemplate1
        ...
        function [Ibrain, Parameters] = MidBrainDetectionSNG(AlignedFish, CompleteTemplate, ZFParameters)
            ...
            %input parameters
            Method = objB.BrainSegmentation.Method;
            Method2 = objB.BrainSegmentation.Method;            
