classdef SNGMidBrainDetection < handle
    ...
    properties
        ...
        %input variables whicht has to be added to SNGInp...
        rows = 100:10:400;
    ...
    methods
        function objB = SNGMidBrainDetection(SpotNGliaObject) %constructor
            ...
            objB.midbrainCenter = SpotNGliaObject.CompleteTemplate.CenterMidBrain;
            objB.polarMidbrainBandWithGaussianWithBlurr = SpotNGliaObject.CompleteTemplate.polarMidbrainBandWithGaussianWithBlurr;
        end
        function All(objB)
            polarTransform(objB)
